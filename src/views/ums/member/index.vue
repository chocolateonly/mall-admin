        ...
        <template #default="scope">
          <el-table :data="scope.row.addressList" size="small" border>
            ...
            <el-table-column align="center" label="收货地址">
              <template #default="addressScope">
                {{
                  (addressScope.row.province || '') +
                  (addressScope.row.city || '') +
                  (addressScope.row.area || '') +
                  (addressScope.row.address || '')
                }}
              </template>
            </el-table-column>
            ...
            <el-table-column align="center" label="是否默认">
              <template #default="addressScope">
                <el-tag v-if="addressScope.row.defaulted == 1" type="success"
                  >是</el-tag
                >
